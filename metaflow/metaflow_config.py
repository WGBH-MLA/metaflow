...
AWS_SECRETS_MANAGER_SESSION_VARS = from_conf("AWS_SECRETS_MANAGER_SESSION_VARS", {})
AWS_SECRETS_MANAGER_CLIENT_PARAMS = from_conf("AWS_SECRETS_MANAGER_CLIENT_PARAMS", {})
